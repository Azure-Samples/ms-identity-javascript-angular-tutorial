...
|                 |               |
|-----------------|---------------|
| <img src="./4-Deployment/1-deploy-storage/ReadmeFiles/topology.png" width="200"> | [**Deploy to Azure Storage and App Service**](./4-Deployment/1-deploy-storage/README.md) </br> Prepare your app for deployment to various **Azure** services. Learn how to package and upload files, configure authentication parameters and use **Azure** services for managing your operations. |
