...
class MsalAuthenticationProvider implements AuthenticationProvider {
     ...
     * This should return a Promise that resolves to an accessToken (in case of success) or 
     * rejects with error (in case of failure). Basically this method will contain the implementation 
     * for getting and refreshing accessTokens
     */
