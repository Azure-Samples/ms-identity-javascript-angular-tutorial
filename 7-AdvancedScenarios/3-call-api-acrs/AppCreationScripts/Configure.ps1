...
#> 
   ...
   Write-Host "Creating the AAD application (msal-dotnet-api-acrs)"
   ...
   $serviceAadApplication = New-AzureADApplication -DisplayName "msal-dotnet-api-acrs" `
   ...
   { 
    ...
    if ($scopes.Count -ge 0) 
    {
             $scope = CreateScope -value access_as_user  `
                -userConsentDisplayName "Access msal-dotnet-api-acrs"  `
                -userConsentDescription "Allow the application to access msal-dotnet-api-acrs on your behalf."  `
                -adminConsentDisplayName "Access msal-dotnet-api-acrs"  `
   ...
   Write-Host "Done creating the service application (msal-dotnet-api-acrs)"
   ...
   Add-Content -Value "<tr><td>service</td><td>$currentAppId</td><td><a href='$servicePortalUrl'>msal-dotnet-api-acrs</a></td></tr>" -Path createdApps.html
   ...
   Write-Host "Creating the AAD application (msal-angular-spa-acrs)"
   # create the application 
   $clientAadApplication = New-AzureADApplication -DisplayName "msal-angular-spa-acrs" `
                                                  -HomePage "https://localhost:4200" `
                                                  -ReplyUrls "https://localhost:4200" `
                                                  -PublicClient $False
   ...
   Write-Host "Done creating the client application (msal-angular-spa-acrs)"

   # URL of the AAD application in the Azure portal
   # Future? $clientPortalUrl = "https://portal.azure.com/#@"+$tenantName+"/blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/Overview/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   $clientPortalUrl = "https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/CallAnAPI/appId/"+$clientAadApplication.AppId+"/objectId/"+$clientAadApplication.ObjectId+"/isMSAApp/"
   Add-Content -Value "<tr><td>client</td><td>$currentAppId</td><td><a href='$clientPortalUrl'>msal-angular-spa-acrs</a></td></tr>" -Path createdApps.html

   $requiredResourcesAccess = New-Object System.Collections.Generic.List[Microsoft.Open.AzureAD.Model.RequiredResourceAccess]

   # Add Required Resources Access (from 'client' to 'service')
   Write-Host "Getting access from 'client' to 'service'"
   $requiredPermissions = GetRequiredPermissions -applicationDisplayName "msal-dotnet-api-acrs" `
