...
Function ConfigureApplications
{
   ...
   # create the application 
   $spaAadApplication = New-MgApplication -DisplayName "ProfileSPA" `
                                                   -Spa `
                                                   @{ `
    ...
    Update-MgApplication -ApplicationId $spaAadApplication.Id -IdentifierUris @("https://$tenantName/ProfileSPA")
    ...
    Write-Host "Done creating the spa application (ProfileSPA)"
    ...
    Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>ProfileSPA</a></td></tr>" -Path createdApps.html
    $requiredResourcesAccess = New-Object System.Collections.Generic.List[Microsoft.Graph.PowerShell.Models.MicrosoftGraphRequiredResourceAccess]
    ...
    $dictionary = @{ "Enter_the_Application_Id_Here" = $spaAadApplication.AppId;"Enter_the_Tenant_Info_Here" = $tenantId;"Enter_the_Application_Id_of_Service_Here" = $serviceAadApplication.AppId;"Enter_the_Redirect_Uri_Here" = $spaAadApplication.Spa.RedirectUris };
